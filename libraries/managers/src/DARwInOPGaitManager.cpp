  ...
  mIsWalking(false)
{
  ...
  y_offset_RL = &mWalking->Y_OFFSET;
  z_offset_RL = &mWalking->Z_OFFSET;
  period_time_RL = &mWalking->PERIOD_TIME;
  dsp_ratio_RL = &mWalking->DSP_RATIO;
  step_forward_back_ratio_RL = &mWalking->STEP_FB_RATIO;
  foot_height_RL = &mWalking->Z_MOVE_AMPLITUDE;
  swing_right_left_RL = &mWalking->Y_SWAP_AMPLITUDE;
  swing_top_down_RL = &mWalking->Z_SWAP_AMPLITUDE;
  arm_swing_gain_RL = &mWalking->ARM_SWING_GAIN;
